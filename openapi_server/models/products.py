...
class Products(Model):
    ...
    def comment(self, comment: str):
        ...
        if comment is not None and not re.search(r'^example-[0-9a-z]', comment):  # noqa: E501
            raise ValueError(r"Invalid value for `comment`, must be a follow pattern or equal to `/^example-[0-9a-z]/`")  # noqa: E501
    ...
    def build_time(self, build_time: str):
        ...
        if build_time is not None and not re.search(r'^example-[0-9a-z]', build_time):  # noqa: E501
            raise ValueError(r"Invalid value for `build_time`, must be a follow pattern or equal to `/^example-[0-9a-z]/`")  # noqa: E501
